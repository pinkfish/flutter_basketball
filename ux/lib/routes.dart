...
class BasketballAppRouter {
  static fluro.Router createRouter(
    ...
    router.define("/Team/Edit/:id", handler: fluro.Handler(
        handlerFunc: (BuildContext context, Map<String, dynamic> vals) {
      analytics.logEvent(
          name: "/Team/Edit",
          parameters: {"teamUid": vals["id"][0].toString()});
    ...
    router.define("/Team/Invite/:id", handler: fluro.Handler(
        handlerFunc: (BuildContext context, Map<String, dynamic> vals) {
      analytics.logEvent(
          name: "/Team/Invite",
          parameters: {"teamUid": vals["id"][0].toString()});
    ...
    router.define("/Team/Users/:id", handler: fluro.Handler(
        handlerFunc: (BuildContext context, Map<String, dynamic> vals) {
      analytics.logEvent(
          name: "/Team/Users",
          parameters: {"teamUid": vals["id"][0].toString()});
    ...
    router.define("/Season/Add/:teamUid", handler: fluro.Handler(
        handlerFunc: (BuildContext context, Map<String, dynamic> vals) {
      analytics.logEvent(
          name: "/Season/Add",
    ...
    router.define("/Game/View/:id", handler: fluro.Handler(
        handlerFunc: (BuildContext context, Map<String, dynamic> vals) {
      analytics.logEvent(
          name: "/Game/View",
    ...
    router.define("/Game/Video/:id", handler: fluro.Handler(
        handlerFunc: (BuildContext context, Map<String, dynamic> vals) {
      analytics.logEvent(
          name: "/Game/Video",
          parameters: {"gameUid": vals["id"][0].toString()});
    ...
    router.define("/Player/View/:id", handler: fluro.Handler(
        handlerFunc: (BuildContext context, Map<String, dynamic> vals) {
      analytics.logEvent(
          name: "/Player/View",
    ...
    router.define("/Player/Edit/:id", handler: fluro.Handler(
        handlerFunc: (BuildContext context, Map<String, dynamic> vals) {
      analytics.logEvent(
          name: "/Player/Edit",
          parameters: {"playerUid": vals["id"][0].toString()});
    ...
    router.define("/Game/Stats/:id/:season/:team", handler: fluro.Handler(
        handlerFunc: (BuildContext context, Map<String, dynamic> vals) {
    ...
    router.define("/Game/Player/:game/:player", handler: fluro.Handler(
        handlerFunc: (BuildContext context, Map<String, dynamic> vals) {
    ...
    router.define("/Media/Add/Url/:game", handler: fluro.Handler(
        handlerFunc: (BuildContext context, Map<String, dynamic> vals) {
    ...
    router.define("/Media/Add/Photo/:game", handler: fluro.Handler(
        handlerFunc: (BuildContext context, Map<String, dynamic> vals) {
    ...
    router.define("/Media/Add/Stream/:game", handler: fluro.Handler(
        handlerFunc: (BuildContext context, Map<String, dynamic> vals) {
    ...
    router.define("/Game/Media/:game/:media", handler: fluro.Handler(
        handlerFunc: (BuildContext context, Map<String, dynamic> vals) {
    ...
    router.define("/Invite/List", handler: fluro.Handler(
        handlerFunc: (BuildContext context, Map<String, dynamic> vals) {
      analytics.logEvent(name: "/Invite/List", parameters: {});
      return InviteListScreen();
    }));
    router.define("/Invite/AcceptInviteToTeam/:invite", handler: fluro.Handler(
        handlerFunc: (BuildContext context, Map<String, dynamic> vals) {
    ...
    router.define("/Login/Home", handler: fluro.Handler(
        handlerFunc: (BuildContext context, Map<String, dynamic> vals) {
      analytics.logEvent(name: "/Login/Home", parameters: {});
      return LoginScreen();
    }));
    router.define("/Login/ForgotPassword", handler: fluro.Handler(
        handlerFunc: (BuildContext context, Map<String, dynamic> vals) {
      analytics.logEvent(name: "/Login/ForgotPassword", parameters: {});
      return ForgotPasswordScreen();
    }));
    router.define("/Login/SignUp", handler: fluro.Handler(
        handlerFunc: (BuildContext context, Map<String, dynamic> vals) {
      analytics.logEvent(name: "/Login/SignUp", parameters: {});
      return SignupScreen();
    }));
    router.define("/Login/Verify", handler: fluro.Handler(
        handlerFunc: (BuildContext context, Map<String, dynamic> vals) {
      analytics.logEvent(name: "/Login/Verify", parameters: {});
      return VerifyEmailScreen();
    }));

    router.define("/Settings", handler: fluro.Handler(
        handlerFunc: (BuildContext context, Map<String, dynamic> vals) {
