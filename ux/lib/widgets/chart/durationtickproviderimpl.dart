...
import 'durationtickprovider.dart';

class DurationTickProviderImpl extends DurationTickProvider {
  final int requiredMinimumTicks;
  final DurationStepper timeStepper;

  DurationTickProviderImpl(this.timeStepper, {this.requiredMinimumTicks = 3});
